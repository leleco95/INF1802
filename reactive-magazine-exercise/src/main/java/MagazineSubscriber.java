...
public class MagazineSubscriber implements Flow.Subscriber<Integer>  {
    ...
    private Integer itemsReceivedCount;
    ...
    public void onNext(Integer item) {
        // @TODO
        if(item - this.lastItem > 1)
            log("Perdi alguma revista entre a " + this.lastItem + " e a " + item + "!");
        this.lastItem = item;
        this.itemsReceivedCount++;
        takeSomeRest();
    ...
    public void onComplete() {
        // @TODO
        log("Recebi " + this.itemsReceivedCount + " revistas.");
    }
